...
function generateORLReport(property, startDate, endDate, previousDatasheet, previousLineNumber) {
    ...
    if (previousLineNumber && previousDatasheet) {
        ...
        var dataRangeNotation = previousDatasheet + "!A6:" + lastCol + previousLineNumber;
        ...
        var _loop_1 = function (oldRow) {
            ...
            for (var ci = 0; ci < liabilitiesColumns.length; ci++) {
                  ...
                  if (oldSubVal) {
                    ...
                    totals.liabilities[subKey] = (totals.liabilities[subKey] || 0) + Number(oldSubVal);
                  }
                }
        };
        ...
        rows = rows.filter(function (r) {
            return r.slice(4).some(function (v) { return Number(v) !== 0; });
        });    
